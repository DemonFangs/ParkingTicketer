 ...
 */
class ParkingTicketFrame extends JFrame implements MouseListener
{
	 ...
	 */
	public ParkingTicketFrame(IntroFrame introF)
	{
		// ----------------------------------
...
class NumberpadInput extends JFrame implements ActionListener
{
	...
	private ParkingTicketFrame mainWindow;
	 ...
	 */
	public NumberpadInput (String title, ParkingTicketFrame mainWindow, int state)
	{
...
class KeyboardInput extends JFrame implements ActionListener 
{
	...
	public KeyboardInput(String title, ParkingTicketFrame mainWindow)
	{
		this.mainWindow = mainWindow;
...
class IntroFrame extends JFrame implements MouseListener
{
	...
	/**
	 *Implemented to go to the ParkingTicketFrame for user input
	 *{@inheritDoc}
	 */
  	@Override
  	public void mouseClicked(MouseEvent me)
	{
		...
		if (source == parkTick)
		{
			...
			ParkingTicketFrame frame = new ParkingTicketFrame(this);
			frame.pack();
...
class TicketFrame extends JFrame implements ActionListener
{
	...
	private ParkingTicketFrame parent;
	private IntroFrame introF;
	...
	/**
	*/
	public TicketFrame(ParkingTicketFrame parent, IntroFrame introF)
	{
		this.parent = parent;
		this.introF = introF;
